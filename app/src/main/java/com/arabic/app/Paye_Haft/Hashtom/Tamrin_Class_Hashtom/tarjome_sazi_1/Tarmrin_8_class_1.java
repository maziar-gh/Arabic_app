...
public class Tarmrin_8_class_1 extends Activity {
    ...
    private String[][] button = new String[][]{
            ...
            {"مثالی", "دراین قرآن", "برای", "همه", "مثال ها", "از هر ", "زدیم ", "مردم"},//1

            {"ماکردی ؟ ", "خدایان ", "را با", "این کار", "آیا ", "چرا ؟ ", "خدای  ", "تو "},//2

            {"فراموش کرد", "و خلقتش ", "زد  ", "مثالی ", "فراموشی می کنی ", "ما", "برای ", "مثال هایی"},//3
