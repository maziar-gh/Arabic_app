...
public class RecyclerAdaper_Tamrin_8_home_1 extends RecyclerView.Adapter<RecyclerAdaper_Tamrin_8_home_1.MyViewHolder> {

    private int lastPosition = -1;
    private boolean iscolor = true;
    private List<Model_Tarjome_Sazi_8_home_1> itemList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            btn_3 = (Button) itemView.findViewById(R.id.btn_3_tamrin_8_home_1);
            btn_4 = (Button) itemView.findViewById(R.id.btn_4_tamrin_8_home_1);
            btn_5 = (Button) itemView.findViewById(R.id.btn_5_tamrin_8_home_1);
            btn_6 = (Button) itemView.findViewById(R.id.btn_6_tamrin_8_home_1);
            ...
            tv_3 = (TextView) itemView.findViewById(R.id.tv_3_tamrin_8_home_1);
            tv_4 = (TextView) itemView.findViewById(R.id.tv_4_tamrin_8_home_1);
            tv_5 = (TextView) itemView.findViewById(R.id.tv_5_tamrin_8_home_1);
            tv_6 = (TextView) itemView.findViewById(R.id.tv_6_tamrin_8_home_1);
            tv_7 = (TextView) itemView.findViewById(R.id.tv_7_tamrin_8_home_1);
            tv_8 = (TextView) itemView.findViewById(R.id.tv_8_tamrin_8_home_1);
    ...
    public RecyclerAdaper_Tamrin_8_home_1(Context context, List<Model_Tarjome_Sazi_8_home_1> itemList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_tamrin_8_home_1, parent, false);
