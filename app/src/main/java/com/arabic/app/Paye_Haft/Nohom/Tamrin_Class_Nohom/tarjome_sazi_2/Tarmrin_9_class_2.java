...
public class Tarmrin_9_class_2 extends Activity {
    ...
    private String[][] button = new String[][]{
            ...
            {"", "خواندند ", "را", "چطور", "آیا", "درسهایتان", "خواندید؟", "درسهایشان"},//1

            {"را", "کلاس  ", "کلاس ها", "باز می کنید ", "ای دانش آموزان ", "چرا درهای", "باز کردید؟ ", ""},//2

            {"را شنیدید؟", "بچهایشان ", "آن خانم ها ", "بچه هایتان ", "صدای", "آیا ", "شنیدند  ", "ای خانم ها"},//3

            {"", "دادی  ", "به من َ ", "آیا", "استاد", "حرف زدن  ", "داد ", "اجازه "}//4
