...
public class RecyclerAdaper_Tamrin_9_class_2 extends RecyclerView.Adapter<RecyclerAdaper_Tamrin_9_class_2.MyViewHolder> {

    private int lastPosition = -1;
    private boolean iscolor = true;
    private List<Model_Tarjome_Sazi_9_class_2> itemList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            btn_1 = (Button) itemView.findViewById(R.id.btn_1_tamrin_9_class_2);
            btn_2 = (Button) itemView.findViewById(R.id.btn_2_tamrin_9_class_2);
            btn_3 = (Button) itemView.findViewById(R.id.btn_3_tamrin_9_class_2);
            btn_4 = (Button) itemView.findViewById(R.id.btn_4_tamrin_9_class_2);
            btn_5 = (Button) itemView.findViewById(R.id.btn_5_tamrin_9_class_2);
            btn_6 = (Button) itemView.findViewById(R.id.btn_6_tamrin_9_class_2);
            btn_7 = (Button) itemView.findViewById(R.id.btn_7_tamrin_9_class_2);
            btn_8 = (Button) itemView.findViewById(R.id.btn_8_tamrin_9_class_2);
            ...
            tv_1 = (TextView) itemView.findViewById(R.id.tv_1_tamrin_9_class_2);
            tv_2 = (TextView) itemView.findViewById(R.id.tv_2_tamrin_9_class_2);
            tv_3 = (TextView) itemView.findViewById(R.id.tv_3_tamrin_9_class_2);
            tv_4 = (TextView) itemView.findViewById(R.id.tv_4_tamrin_9_class_2);
            tv_5 = (TextView) itemView.findViewById(R.id.tv_5_tamrin_9_class_2);
            tv_6 = (TextView) itemView.findViewById(R.id.tv_6_tamrin_9_class_2);
            tv_7 = (TextView) itemView.findViewById(R.id.tv_7_tamrin_9_class_2);
            tv_8 = (TextView) itemView.findViewById(R.id.tv_8_tamrin_9_class_2);
    ...
    public RecyclerAdaper_Tamrin_9_class_2(Context context, List<Model_Tarjome_Sazi_9_class_2> itemList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_tamrin_9_class_2, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final Model_Tarjome_Sazi_9_class_2 Item = itemList.get(position);
        ...
        holder.btn_okk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                all2 = Tarmrin_9_class_2.ANSEVER[position].replace(" ", "").trim();

                holder.tv_correct.setText(Tarmrin_9_class_2.ANSEVER[position]);
